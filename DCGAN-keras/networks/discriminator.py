...
def PatchGanDiscriminator(output_img_dim, patch_dim, nb_patches):
    ...
    disc_out = Convolution2D(nb_filter=64, (4,4,4), padding='same', strides=(stride,stride,stride), name='disc_conv_1')(input_layer)
    ...
    for i, filter_size in enumerate(filters_list[1:]):
        ...
        disc_out = Convolution2D(nb_filter=filter_size, (4,4,4), padding='same', strides=(stride,stride,stride), name=name)(disc_out)
